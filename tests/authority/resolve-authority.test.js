 ...
 */
{
  ...
  const vectors = [
    ...
    ['TV-CAP-TIME-001 BEFORE_CAPABILITY_VALID_FROM=>INVALID',
      { valid_from: '2026-09-18T13:00:00Z' },
      'INVALID',
      'CAPABILITY_NOT_YET_VALID'],

    ['TV-CAP-TIME-002 AT_CAPABILITY_VALID_UNTIL=>INVALID',
      { valid_until: '2026-09-17T12:00:00Z' },
      'INVALID',
      'CAPABILITY_TEMPORALLY_EXPIRED'],

    ['TV-CAP-TIME-003 MALFORMED_CAPABILITY_VALID_FROM=>INVALID',
      { valid_from: 'not-a-date' },
      'INVALID',
      'CAPABILITY_VALID_FROM_INVALID'],

    ['TV-CAP-TIME-004 MALFORMED_CAPABILITY_VALID_UNTIL=>INVALID', { valid_until: 'not-a-date' }, 'INVALID', 'CAPABILITY_VALID_UNTIL_INVALID'],

    ['TV-CAP-TIME-005 VALID_UNTIL_BEFORE_VALID_FROM=>INVALID', { valid_from: '2026-09-18T13:00:00Z', valid_until: '2026-09-18T12:00:00Z' }, 'INVALID', 'CAPABILITY_TEMPORAL_INCONSISTENCY'],
